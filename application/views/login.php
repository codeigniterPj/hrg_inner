...
xmlhttp.open("GET","./resources/processing"+"?q="+str,true);
xmlhttp.send();
}
</script>
...
<body> 
<div class="wrap"> 
  <form action="<?php echo site_url('/admin_login/logining') ?>" method="post"> 
    <section class="loginForm"> 
      ...
      <div class="loginForm_content"> 
        <fieldset> 
          ...
          <div class="inputWrap"> 
            <input type="text" id="txt1" name="username" placeholder="邮箱/会员帐号/手机号" onKeyUp="showHint(this.value)" autofocus required> <div id="txtHint"><span></span></div>
          </div>
          <div class="inputWrap"> 
